...
//      capability "Window Shade Preset"
    ...
    preferences {
          ...
          input name: "manual", type: "bool", title: "Xiaomi Curtain Manual Move", description: "Manual Move ON", required: true,
             displayDuringSetup: true
   }    
...
def writeManual() {
    def value = settings.manual ? 0 : 1
    zigbee.writeAttribute(CLUSTER_BASIC, 0xFF29, 0x10, value, [mfgCode: "0x115f"])
}
